			...
			<?php echo form_open_multipart($this->uri->uri_string(), array("class" => "form-horizontal", "role" => "form"));?>
         	<div class="row">
            	<div class="col-md-12">
                    ...
                    if(isset($success)){
						//var_dump($success);
                        echo '<div class="alert alert-success">'.$success[0]['status'].'</div>';
                    }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <input type="text" class="form-control" name="emails" placeholder="Email Addresses" value="<?php echo set_value('emails');?>">
                        </div>
                    </div>
